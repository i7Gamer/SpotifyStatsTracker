...
Last.fm genre backfill, data sharing and new user registration - one form,
...
class TestFeatureSettingsForm(OverviewFeaturesTestBase):
    ...
    def test_admin_can_disable_all_four_in_one_submit(self):
        dash = self._makeApp()
